...
class OneStep(tf.keras.Model):
    '''
    A one step model wrapper that assumes an RNN based input to generate one step of output data.
    This can be done continously in a loop to generate output based on previous state.
    '''
...
class SensibleTextOutputMetric():
    def __init__(self, name='sensible_text_output_metric', dtype=None, from_logits=False, axis=-1):
        self.name = name
        self.dtype = dtype
